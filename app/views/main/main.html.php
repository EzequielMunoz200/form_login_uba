        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group  d-flex align-items-center col-12 p-0">
                    <label class="my-2 mr-0" for="dob">Date de naissance<input class="form-control col-9 mt-2" type="date" name="dob" id="dob"></label>
                ...
                <div class="form-group d-flex">
                    <div class="row">
                        <div class="gender">
                            <input class="form-control" type="radio" name="gender" id="genderFemale" value="F"><label class="m-0 pl-2" for="genderFemale">Femme</label>
                        </div>
                        <div class="gender">
                            <input class="form-control" type="radio" name="gender" id="genderMale" value="M"><label class="m-0 pl-2" for="genderMale">Homme</label>
                        </div>
                    </div>
                </div>
